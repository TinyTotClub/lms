...
@frappe.whitelist()
def unassign_course_from_student(student_email: str, course: str):
...
@frappe.whitelist()
def get_student_assignments(student_email: str | None = None):
...
@frappe.whitelist()
def get_recent_assignments(limit: int = 10):
